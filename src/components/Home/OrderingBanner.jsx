  ...
  return (
    <div className="py-16 max-w-6xl mx-auto">
      <div className="text-center space-y-3 mb-12">
        <h2 className="text-6xl font-bold">Order in just 10 minutes</h2>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 text-center">
        <div className="flex flex-col items-center">
          ...
          <h4 className="text-3xl font-bold mt-4">Order your food</h4>
        ...
        <div className="flex flex-col items-center">
          ...
          <h4 className="text-3xl font-bold mt-4">Delivery & Pickup</h4>
          <p className="px-4 mt-2 max-w-sm text-gray-500">
        ...
        <div className="flex flex-col items-center">
          ...
          <h4 className="text-3xl font-bold mt-4">Delicious Recipe</h4>
          <p className="px-4 mt-2 max-w-sm text-gray-500">
